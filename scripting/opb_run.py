...
regression_model_args=['context','action','reward','pscore','position','action_dist']

estimator_args_dict = {'DirectMethod':['position','action_dist','estimated_rewards_by_reg_model'],
                       'DoublyRobust':['reward', 'action', 'position', 'pscore', 'action_dist',\
                                       'estimated_rewards_by_reg_model'],
                       'DoublyRobustWithShrinkage':['reward', 'action', 'position', 'pscore', 'action_dist',\
                                                    'estimated_rewards_by_reg_model'],
                       'InverseProbabilityWeighting':['reward', 'action', 'position', 'pscore', 'action_dist'],
                       'ReplayMethod':['reward', 'action', 'position'],
                       'SelfNormalizedDoublyRobust':['reward', 'action', 'position', 'pscore', 'action_dist',\
                                                     'estimated_rewards_by_reg_model'],
                       'SelfNormalizedInverseProbabilityWeighting':['reward', 'action', 'position', 'pscore', 'action_dist'],
                       'SwitchDoublyRobust':['reward', 'action', 'position', 'pscore', 'action_dist',\
                                             'estimated_rewards_by_reg_model'],
                       'SwitchInverseProbabilityWeighting':['reward', 'action', 'position', 'pscore', 'action_dist',\
                                                            'estimated_rewards_by_reg_model']}
...
if __name__ == '__main__':
    ...
    estimator, estimator_dict = utils.load_obj_from_spec(estimator_spec_path, return_dict=True)
    ...
    if 'estimated_rewards_by_reg_model' in required_args:
        estimated_rewards_model = RegressionModel(Ridge(), n_actions=feedback['n_actions'],\
                                   action_context=feedback['action_context'], len_list=dataset.len_list)
        reg_dict = {}
